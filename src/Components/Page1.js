...
// import Logo from "../Components/career.jpeg"
...
const [image, setimage] = useState("https://thumbs.dreamstime.com/z/career-icon-trendy-logo-concept-white-background-human-resources-collection-133513442.jpg");
...
if(!formData.companyname && !formData.headOffice && !formData.Country && !formData.city && !formData.contactNumber){
  navigate("/SecondPage")
}
else {
...
return (
<div style={{display:"flex",justifyContent:"space-around"}} className="Page">
...
<div spacing={1} style={{ textAlign: "left", display: "flex" }}>
...
}} src={image} alt="profile photo" /> : null}
</div>
